        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-6 gap-12 items-center">
            <div className="lg:col-span-2 order-2 lg:order-1">
              ...
              >
                <div className="bg-white/90 backdrop-blur rounded-2xl shadow-card p-2 max-w-3xl mx-auto lg:mx-0 relative group-hover:shadow-float transition-shadow border border-cyan-200/50 lg:origin-right lg:scale-[1.08] lg:ml-0">
                  <img 
